    ...
    <div class="container">
      <div class="section">
        <div class="column is-6 is-offset-3">
          <center>
            <h1 class="title" style="padding-top: 20px">Lofule Installation</h1><br>
          </center>
          <div class="box">
            <?php
switch ($step) {
...
exit;
                ...
                $templine = '';
                $lines = file('../includes/lofule.sql');
...
if ($_POST && isset($_POST["dbscs"])) {
            ...
            ?>
                <center>
                  <p><strong>See your Admin Credential.</strong></p><br>
                </center>
                <form action="#" id="adminDetailForm" method="POST">
                  <div class="field">
                    <label class="label">Admin Email</label>
                      <div class="control">
                        <input class="input" type="email" id="email" value="admin@admin.com" name="email" readonly>
                  ...
                  <div class="field">
                    <label class="label">Admin Password</label>
                      <div class="control">
                        <input class="input" type="text" id="password" value="password" name="password" readonly>
                        <p class="password" style='color:#f74416;'></p>
                      </div>
                  </div>
                  <div style='text-align: right;'>
                        <button type="button" id="proccedLogin" class="button is-link">Procced to Login</button>
                    </div>
                </form>
                <?php
} else {?>
  ...
  <div class="content has-text-centered">
    <p>© <?php echo date('Y'); ?> Copyright Lofule by Our Team
  </div>
</body>
